...
let pluschiffre : (int -> int, char) ranalist = chiffre ++> fun n -> epsilon_res ((+) n)
let plus10chiffre : (int -> int, char) ranalist = chiffre ++> fun n -> epsilon_res (fun x -> 10 * x + n)
...
let _ = star_R2L pluschiffre 0                     (list_of_string "132-reste")
let _ = star_L2R 0 pluschiffre                     (list_of_string "132-reste")
let _ = star_L2R 0 plus10chiffre                   (list_of_string "123-reste")
let _ = (chiffre ++> fun n -> terminal '.' -+> star_L2R n plus10chiffre)
        (list_of_string "7.123-reste")
